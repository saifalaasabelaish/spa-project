...
const BookingPage = () => {
    return (
        ...
        <img src="images/booking.png" alt="booking page" className=" vh-100 w-100 img-fluid d-flex"></img>
        <div className="position-absolute top-0 col-12 col-md-12 col-sm-12 ">
        <HeaderPage title ="BOOKING PAGE"/>
        <div className="row w-100 align-items-center justify-content-center">
        <div className="mt-4 col-md-8 col-sm-8 col-lg-7 rounded bg-white p-4 shadow">
