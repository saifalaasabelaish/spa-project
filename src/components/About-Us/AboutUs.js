...
<div><h1>About us </h1></div>
    <div className="about">
        ...
        <div className="about">
            <h2>Team of spa</h2>
            <p>-Shayne Crocker:work in massage </p>
            <p> -Magen Martin:working in makeup </p>
            <p> -Amanda Mollett:working in massage </p>
            <p> -Lydia Smothers:wrking in massage </p>
        </div>
        <div className="about">
            <h2>Founders of spa </h2>
            <p>lele mart:business woman</p>
            <p>Jo kateb:investor</p>
            <p>karol mo:business women</p>
        </div>
        <div className="about">
            <h2>Location</h2>
            <br/>
           <a className="btn btn-outline-dark" href="https://www.google.com/maps/place/Nagham.Pro/@32.224243,35.2466208,17z/data=!3m1!4b1!4m5!3m4!1s0x151ce19096423d5f:0x34306c6102b97f21!8m2!3d32.224243!4d35.2444321">
            ...
            <div className="staff">
                <div className="position-relative d-flex">
                    ...
                    <div className="container">
                        ...
                        <a className='btn btn-outline-dark' href="n"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        < a className='btn btn-outline-dark'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
