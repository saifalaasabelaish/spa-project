      ...
      <div className='container'>
        ...
        <div className="card-group ">
          <div className='d-flex w-100 '>
            <AboutUsCard img1="./images/nn.webp" alt="1" title="Iyla Sam" Paragraph="grew up on PEI and moved to Halifax to pursue a diploma in Massage Therapy." />
            <AboutUsCard img1="./images/man3.jpg" alt="1" title="Othman Ahmad" Paragraph="is an experienced Registered Massage Therapist.  Having come from away (in most recent years Edmonton, AB)." />
            <AboutUsCard img1="./images/nn2.jpg" alt="1" title="Cortny Dan" Paragraph="attained her goal in 2017 of completing her studies at the Private Institute of Hair Design and Aesthetics…." />
        ...
        <div className='d-flex w-100'>
          ...
          <AboutUsCard img1="./images/nj.jpg" alt="1" title="Lele Mart" Paragraph="business woman" />


          <AboutUsCard img1="./images/ni.jpg" alt="1" title="Jo kateb" Paragraph="investor" />
