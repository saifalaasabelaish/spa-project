        ...
        <div className="container">
          ...
          <div className="container">
            <div className="row my-3">
              ...
              <ServicesCard imag="./images/bodycare.jpg" ser_card_title="BODY CARE" ser_card_text="Having a spa body treatment yields a number of great benefits, from preventing the signs of aging and creating a sense of relaxation to flushing out toxins and promoting the appearance of glowing, radiant skin." />
              ...
              <ServicesCard imag="./images/haircare.jpg" ser_card_title="HAIR CARE" ser_card_text="Offering an unmatched assortment of Kalamazoo’s best salon services, including hair coloring, styling, treatments, and finishes, we utilize the industry’s best hair care products." />
            </div>
          </div></div></div>
    </>
  );
