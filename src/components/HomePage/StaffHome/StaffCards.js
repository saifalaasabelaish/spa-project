        ...
        <div className="full-width-wrapper flex-content">
          <div className="row align-items-center">
            <div className="col-sm-6 col-md-4 col-lg-3">
              <img src='./images/shayne.jpeg' className=" img-fluid six-col rounded-circle " alt="first "></img>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <img src='./images/megan.jpg' className="img-fluid six-col rounded-circle " alt="scond"></img>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <img src='./images/amanda.jpg' className="six-col img-fluid rounded-circle " alt="three"></img>
            ...
            <div className="col-sm-6 col-md-4 col-lg-3">
              <img src='./images/lydia.jpg' className="six-col img-fluid rounded-circle " alt="four "></img>
