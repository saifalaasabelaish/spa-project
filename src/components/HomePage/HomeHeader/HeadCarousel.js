    ...
    return (
     ...
     with different sentences, to prevent repetition in the main file */}
            <div className='head'>
                ...
                <div className='col-12 col-md-7 col-lg-7 col-sm-6 col-xxl-7 container cont justify-content-center position-absolute top-50 start-50 translate-middle d-flex align-items-center'>
