...
{ 
    ...
    <img src={props.img} className="img-top img-fluid six-col rounded-circle  mx-2 " alt={props.alt1}></img></div>
   <div className="titleStaff text-center mt-3">
    <h5 >{props.title}</h5>{props.paragraph1}{props.children} </div>  </div>
      </>  
