import './About.css'
import first from './img.f/uu.jpeg'
import scond from './img.f/qq.jpg'
import three from './img.f/qw.jpg'
import four from './img.f/ee.jpg'
const Staff= () =>{
    return(
        <section>
        <div className="staff">
     ...
     <a className='btn btn-outline-dark' href="n"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
    ...
    <a className='btn btn-outline-dark'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
